...
main:
	...
	la	$t0, puzzle_flag
	li	$t1, 0
	sw	$t1, 0($t0)				#Initialize puzzle flag as 0
...
.set at
	la	$k0, chunkIH
	sw	$a0, 0($k0)			#Save $a0 and $a1 so we can use them
	sw	$a1, 4($k0)
...
interrupt_dispatch:
	mfc0	$k0, $13			#Again, cause reg
	beq	$k0, $0, done			#Handled all interrupts

	and	$a0, $k0, BONK_MASK		#Check for bonk
	bne	$a0, $0, bonk_interrupt

	and	$a0, $k0, TIMER_MASK		#Check for timer
